...
_See code: [src/commands/dev/audit/messages.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/audit/messages.ts)_
...
_See code: [src/commands/dev/configure/repo.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/configure/repo.ts)_
...
_See code: [src/commands/dev/configure/secrets.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/configure/secrets.ts)_
...
_See code: [src/commands/dev/convert/messages.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/convert/messages.ts)_
...
_See code: [src/commands/dev/convert/script.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/convert/script.ts)_
...
_See code: [src/commands/dev/generate/command.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/generate/command.ts)_
...
_See code: [src/commands/dev/generate/flag.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/generate/flag.ts)_
...
_See code: [src/commands/dev/generate/library.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/generate/library.ts)_
...
_See code: [src/commands/dev/generate/plugin.ts](https://github.com/salesforcecli/plugin-dev/blob/2.1.3/src/commands/dev/generate/plugin.ts)_
